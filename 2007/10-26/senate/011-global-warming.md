---
granule: CRECB-2007-pt20-Pg28486
date: 2007-10-26
edition: CRECB
section: SENATE
page: 28486
...
colleagues:
     ...
     computer models in which one minor variable (CO<INF>2</INF>) 
     is considered the sole driver for the entire global climate 
     system.

  How minor is that manmade CO<INF>2</INF> variable in the atmosphere?
...
August how minuscule mankind's CO<INF>2</INF> emissions are in relation 
...
the Weather Channel.
     ...
     anthropogenic CO<INF>2</INF> contribution today would be 
...
CO<INF>2</INF> you have, the warmer the world is. That is very 
simplistic and it is untrue. Scientists are reporting in peer-reviewed 
literature that increasing CO<INF>2</INF> in the atmosphere will not 
...
CO<INF>2</INF> came after these high temperatures. Eighty percent came 
after the 1940s. That is a very interesting thing because, if you look 
at it, you would say if 80 percent of the CO<INF>2</INF> came after the 
1940s, would that not precipitate a warming period--if they are right--
in terms of CO<INF>2</INF> affecting warmer climate change? That didn't 
...
this year, and this is significant:
     ...
     percent) in atmospheric CO<INF>2</INF>. Second, lower 
     ...
     CO<INF>2</INF> has increased by 55 parts per million (17 
     percent).
...
is yet another indication that CO<INF>2</INF> levels and temperature 
...
the relationship that the more CO<INF>2</INF>, a warmer world. The 
third critical point on global warming is to debunk the notion that the 
more CO<INF>2</INF>, the warmer the world as simplistic. Scientists and 
peer-reviewed scientists are increasingly revealing that catastrophic 
climate fears of rising CO<INF>2</INF> are simply unsustainable.
...
Wisconsin, dismissed the rising CO<INF>2</INF> fears very bluntly. He 
said:
...
overestimate the warming effect of CO<INF>2</INF> in the atmosphere.
  Climatologist Dr. Ball described how CO<INF>2</INF>'s warming impact 
diminishes. A quote from Dr. Timothy Ball:

       Even if CO<INF>2</INF> concentration doubles or triples, 
     the effect would be minimal. The relationship between 
     temperature and CO<INF>2</INF> is like painting a window 
     black to block the sunlight. The first coat blocks most of 
     the light. The second and third reduce very little more. The 
     current CO<INF>2</INF> levels are like the first coat of 
...
almost all of the warming from CO<INF>2</INF> that mankind has put into 
the atmosphere.
...
atmospheric CO<INF>2</INF>, ruling out the greenhouse gas as driver of 
...
CO<INF>2</INF> rises and the temperature warms.''
...
decisive role of CO<INF>2</INF> in warming. Here is an excerpt about 
the study: ``CO<INF>2</INF> is not the big bogeyman of climate change 
...
explained: ``Not CO<INF>2</INF>, but water vapor is the most important 
...
movie has hyped CO<INF>2</INF> so much that nobody seems to take note 
of it.''
...
noted that CO<INF>2</INF> impact on warming may be ``excessively 
exaggerated.'' Here is an excerpt: ``The global climate warming is not 
solely affected by the CO<INF>2</INF> greenhouse effect. The best 
example is temperature obviously cooling however atmospheric 
CO<INF>2</INF> concentration is ascending from 1940s to 1970s. Although 
the CO<INF>2</INF> greenhouse effect on global climate change is 
...
the CO<INF>2</INF> emissions from cars and trucks. Stating it in a 
different way, the gasses released by stock actually exceed the 
CO<INF>2</INF> in the atmosphere from all the cars and trucks in the 
...
January of this year:
  ...
  Perhaps the most scathing indictment of the ``more CO<INF>2</INF> 
...
institution. Giegengack said:
     ...
     CO<INF>2</INF> in the atmosphere traps the sun's heat. That's 
     just wrong. It is a natural interplay. It's hard for us to 
     say that CO<INF>2</INF> drives temperature. It's easier to 
     say temperature drives CO<INF>2</INF>.
  ...
  He said:
     ...
     CO<INF>2</INF>; not the CO<INF>2</INF> that controlled the 
     temperature.
...
is the temperature that is controlling the CO<INF>2</INF>.
  Now, this might be a bit technical, but what Giegengack is saying 
here is that it is temperatures that control CO<INF>2</INF>. This is 
...
not reduce the concentration in the atmosphere; CO<INF>2</INF> is just 
...
scientific skepticism about CO<INF>2</INF>'s role in the Earth's 
climate system.
...
environment. He says: But they are a doing a disservice.
  Rancourt wrote, on February 27, 2007:
     ...
     lifestyle choices, in relation to CO<INF>2</INF> emission, 
  ...
  He also noted that even if CO<INF>2</INF> emissions were a grave 
...
that manmade gases, methane, CO<INF>2</INF>, were causing climate 
...
CO<INF>2</INF>, methane gases are causing climate change. Only 7 
...
Congress, known as cap and trade--cap and trade the CO<INF>2</INF> 
...
me quote from the CBO report:
     ...
     the cost of meeting a cap on CO<INF>2</INF> emissions would 
...
purposes. There are some real pollutants out there. CO<INF>2</INF> is 
not a pollutant; it is a fertilizer. But there are real pollutants out 
there, SO<INF>X</INF>, NO<INF>X</INF>, and mercury. By working with our 
...
SO<INF>X</INF>, NO<INF>X</INF>, and mercury. Others might put this list 
