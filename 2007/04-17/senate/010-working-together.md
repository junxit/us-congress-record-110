...
saving a considerable amount of money under the program. On average 
seniors are saving $1,200 yearly on drug costs. A survey reported 80 
percent of seniors are happy with the Part D benefits that went into 
effect recently. Folks in Wyoming are certainly telling me they like 
the plans that are available there. There are fewer plans available in 
a smaller population State than there are in some others. Nevertheless, 
there are plans available. They are available at the local drugstore, 
and they have an option of several plans from which to choose which is 
very important for us to maintain in the Part D program.
