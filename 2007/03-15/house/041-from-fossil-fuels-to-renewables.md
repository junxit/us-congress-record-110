---
granule: CREC-2007-03-15-pt1-PgH2601-2
date: 2007-03-15
edition: CREC
section: HOUSE
page: H2601
citation: 153 Cong. Rec. H2601
---

# FROM FOSSIL FUELS TO RENEWABLES

**Speaking:** Bartlett, Roscoe G. (B000208) [R-MD], Markey, Edward J. (M000133) [D-MA]
...
more CO<INF>2</INF>, that may not produce global warming if you are 
...
the release of these greenhouse gases, CO<INF>2</INF> being one of the 
...
between CO<INF>2</INF> and warming.
...
that every time that CO<INF>2</INF> was up, the Earth was warmer. So 
that at least is a presumptive evidence that CO<INF>2</INF> certainly 
...
sequestered the CO<INF>2</INF> then over thousands of years perhaps.
...
are now releasing into the atmosphere all the CO<INF>2</INF> that has 
...
the CO<INF>2</INF> which the tree took out of the atmosphere. So 
...
desire and you wouldn't increase the CO<INF>2</INF> in the atmosphere 
because for every pound of CO<INF>2</INF> that you released into the 
...
message. And if I may, just for 10 seconds because I know the gentleman 
shares my view on this, I think we both drive hybrids. I think the 
gentleman is the Chair of the Hybrid Caucus, as a matter of fact. And 
we both know that the technology exists if we make a commitment as a 
nation. So here is just one little statistic I would like to put out 
there:
...
was the 14th, just about a year ago I came here

[[Page H2604]]

for the first time, the 14th of last month, March. And we were putting 
our charts together and we were trying to decide what to call this 
phenomenon. Were we going to call it the ``great rollover,'' when you 
reach the top and start down the other side, or were we going to call 
it ``peak oil''? And we had a long conversation in the office about 
what we should call it, and we finally decided we would call it ``peak 
oil.''
...
there in Easter Island and somebody didn't fix it. There wasn't 
...
the countries around the Caspian. But largely we are pretty aware of 
what the geology is, and we know that gas and oil can occur in only 
certain unique geological formations.
...
day after tomorrow, you are less certain, so that gets to be a big 
funnel as you go out. So that is what these various probabilities are.
...
CO<INF>2</INF> down there and live steam and so forth, maybe you can 
...
he was right about the United States, why

[[Page H2607]]

shouldn't he be right about the world, and why shouldn't we have been 
...
is not an energy source. We talk about it because when you burn it you 
get water that is pretty darn clean, and it is a great candidate for 
fuel cells, if we ever get fuel cells. Think of hydrogen as a battery, 
