...
provide greater oversight of NSA's surveillance activity. Our 
legislation also makes some key changes to FISA in order to streamline 
and expedite the process in response to the administration's argument 
that the current framework was too cumbersome.
