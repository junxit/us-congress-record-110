---
granule: CRECB-2008-pt8-Pg11784-2
date: 2008-06-06
edition: CRECB
section: SENATE
page: 11784
...
use CO<INF>2</INF> from fossil fuels at electric power plants and other 
facilities, that CO<INF>2</INF> would not be released into the 
atmosphere to impact the climate. At the same time, you can use that 
CO<INF>2</INF> instead for beneficial purposes and invest into an oil 
well. Thus, you not only put the CO<INF>2</INF> underground and 
...
the CO<INF>2</INF> and producing byproducts, including hydrogen, 
chloride, and baking soda. The baking soda contains CO<INF>2</INF>. In 
fact, this company brought me some cookies and said these come from 
coal. They are making the point that, by capturing the CO<INF>2</INF> 
...
to capture CO<INF>2</INF> and protect our environment, even as we use 
...
by taking CO<INF>2</INF> off of a plant and putting it in greenhouses 
that produce algae. Algae is produced in water which need sunlight and 
CO<INF>2</INF> to grow. So it consumes CO<INF>2</INF> by producing 
...
the CO<INF>2</INF> and produce a beneficial use which is a biodiesel 
