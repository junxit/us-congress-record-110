...
the Record, as follows:
     ...
     & Co., 104 F.R.D. 103, 105 (S.D.N.Y. 1985) and Hartford Fire 
     Ins. Co. v. Garvey, 109 F.R.D. 323, 332 (N.D.Cal. 1985), set 
     out a multi-factor test for determining whether inadvertent 
     disclosure is a waiver. The stated factors (none of which is 
     dispositive) are the reasonableness of precautions taken, the 
     time taken to rectify the error, the scope of discovery, the 
     extent of disclosure and the overriding issue of fairness. 
     The rule does not explicitly codify that test, because it is 
     really a set of non-determinative guidelines that vary from 
     case to case. The rule is flexible enough to accommodate any 
     of those listed factors. Other considerations bearing on the 
     reasonableness of a producing party's efforts include the 
     number of documents to be reviewed and the time constraints 
     for production. Depending on the circumstances, a party that 
     uses advanced analytical software applications and linguistic 
     ...
     system of records management before litigation may also be 
     relevant.
       The rule does not require the producing party to engage in 
     a post-production review to determine whether any protected 
     communication or information has been produced

[[Page 2777]]

     by mistake. But the rule does require the producing party to 
     ...
     made in a state court proceeding is enforceable under 
