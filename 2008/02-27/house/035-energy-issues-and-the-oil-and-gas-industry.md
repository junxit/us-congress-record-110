...
to use coal, until we learn how to capture the CO<INF>2</INF> and 
sequester that CO<INF>2</INF>, the equivalent amount of electricity 
...
that CO<INF>2</INF> and climate change are the single biggest things 
threatening our lives. Well, if CO<INF>2</INF> is the biggest threat to 
...
thoughtful compromise across a lot of folks who are in this arena, 
